...
- [evidence/2026-09-09/](evidence/2026-09-09/) — the September 9 audit, its
...
- [evidence/baselines/](evidence/baselines/) — byte-preserved baseline
  manifests
- [evidence/NFL_AUDIT_RUN_8_MANIFEST.json](evidence/NFL_AUDIT_RUN_8_MANIFEST.json)
...
- [reference/football/](reference/football/) — shared weekly data and rebuild
  notes
- [reference/research/](reference/research/) — external source surveys with
