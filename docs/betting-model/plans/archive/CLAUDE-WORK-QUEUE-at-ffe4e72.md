...
|---|---|---|---|
| 0 Reconcile | implemented | [`evidence/2026-09-10/slice0/SOURCE-MANIFEST.md`](../../audits/repository-evidence/2026-09-10/slice0/SOURCE-MANIFEST.md) | Findings marked "not yet re-verified" in 0.1 are verified inside their own slice, not here. |
...
| 10 Prospective decision | implemented | [`evidence/2026-09-10/DECISION-RECORD.md`](../../audits/repository-evidence/2026-09-10/DECISION-RECORD.md) | A record of what the evidence supports, which is not a profitability verdict. No prospective observation has yet been made. |
...
|---|---|---|
| 1 | The exact fixes for C01–C17 | [`evidence/2026-09-10/CODEX-6-HANDOFF.md`](../../audits/repository-evidence/2026-09-10/CODEX-6-HANDOFF.md), one section per slice, each naming the defect it reproduced first. |
...
| 7 | The fixed experiment decision record | [`evidence/2026-09-10/DECISION-RECORD.md`](../../audits/repository-evidence/2026-09-10/DECISION-RECORD.md). It records that the question is now askable and has not been asked. |
| 8 | Updated folder dispositions, with the plan and routes still working | [`reference/architecture/folder-map.csv`](../../archive/repository-reference/reference/architecture/folder-map.csv) recomputed to 820 dispositions, none undisposed. Typecheck, lint, build and the real-server startup smoke all pass. |
| 9 | A plain-language statement to Nick | The end of [`DECISION-RECORD.md`](../../audits/repository-evidence/2026-09-10/DECISION-RECORD.md) §1 and §4. |
