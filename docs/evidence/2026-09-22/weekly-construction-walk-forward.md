...
(`dd7cec20`, #154) when this was written; S-03's forward rows F028-F031 (F001-F004 on its branch, F018-F021 before PROJ-02-a took those ids on main) are in it (`8ddebcd8`).
