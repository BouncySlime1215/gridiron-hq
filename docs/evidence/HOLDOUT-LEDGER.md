...
| F007 | 2026-09-23 | LIVING-01a (branch claude/local-living-01a-v3) | fantasy | other | Descriptive: engagement-state counts for the 46 teams in Nick's 5 ESPN leagues, 2026 weeks 1-2 (and week 3 partial), from the activity producer | state counts, engaged / drifting / checked out, league_transactions_raw via engine_events (local copy) | descriptive only, no outcome graded: 17 / 28 / 1 through week 2; 18 / 26 / 2 through partial week 3 |  |  |  |  |  |  | no (default-off) | `docs/evidence/2026-09-23/living-01a-activity-model.md` section "ESPN 2026 live check" | graded gates are Sleeper 2023 and 2024 (fit 2021-22); no L row: 2025 never opened; no job fit or registry opening |
