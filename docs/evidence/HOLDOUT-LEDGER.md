...
S-03's rows (F018-F021) were F001-F004 on its branch and were renumbered when it merged (F016
and F017 are claimed by open PRs #207 and #215). S-02's forward look at the same 2026 week 2
(2026-09-22 20:45 UTC, `docs/evidence/2026-09-22/weekly-construction-grade.md` section 8)
predates this ledger and has no row; it is noted on F018.
...
`F` rows: whichever merges second renumbers. (S-03 merged second and took F018-F021.)
