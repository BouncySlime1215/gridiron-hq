...
| L163 | 2026-09-23 | PROJ-01-a-2025 (branch claude/local-proj-01-a-2025-v3) | fantasy | other | ONE-TIME 2025 confirmation, pre-registered (PR #222's frozen spot definition, no re-fit, no new spots): the `qb_change` blind spot's pooled excess error keeps the same (negative) sign in 2025 that it had pooled over 2021-2024 (-0.5678 [-0.9459,-0.1898], 95%) | pooled cluster-robust mean excess error (actual - ESPN, spot rows minus same-season/position complement), 2025 only, QB/RB/WR/TE weeks 1-17, ESPN proj >= 5.0 | CONFIRMED: same sign (negative) as 2021-2024 | -0.9779 | -1.7406 | -0.2153 | 95 | 0.0120 | - | n.a. | `docs/evidence/2026-09-23/proj-01a-2025-confirm.md` | n=282 rows, 132 player clusters; local copy (.local-db backup), not production; run via `scripts/rnd/espn-mistake-map.mjs --confirm-2025 L163` (requires `GRIDIRON_PROJ_01_A_2025_ENABLED=1`); `refuseHoldout()` stays the default for every other path in that file |
| L164 | 2026-09-23 | PROJ-01-a-2025 (branch claude/local-proj-01-a-2025-v3) | fantasy | other | ONE-TIME 2025 confirmation, pre-registered (PR #222's frozen spot definition, no re-fit, no new spots): the `blowout_underdog_rb` blind spot's pooled excess error keeps the same (negative) sign in 2025 that it had pooled over 2021-2024 (-0.6615 [-1.2271,-0.0958], 95%) | pooled cluster-robust mean excess error (actual - ESPN, spot rows minus same-season/position complement), 2025 only, RB only, weeks 1-17, ESPN proj >= 5.0 | NOT CONFIRMED: sign flipped positive in 2025, not significant | +0.1028 | -0.8964 | +1.1020 | 95 | 0.8401 | - | n.a. | `docs/evidence/2026-09-23/proj-01a-2025-confirm.md` | n=122 rows, 48 player clusters; local copy (.local-db backup), not production; run via `scripts/rnd/espn-mistake-map.mjs --confirm-2025 L163` (companion row to L163, same run); `refuseHoldout()` stays the default for every other path in that file |
