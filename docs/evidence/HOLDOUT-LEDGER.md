...
| F010 | 2026-09-23 | RL-8-2b (branch claude/local-rl-8-2b-trade-split-fresh-test) | fantasy | other | Trade split (arms a and b) holds on 2026 forward trades | win rate on 2026 trades | not run: no 2026 Sleeper trade outcomes pulled (coordinator ruling NICK-2025: not needed); both arms failed on 2025 anyway |  |  |  |  |  |  | n.a. | `docs/evidence/2026-09-23/trade-split-2025-preregistration.md` section 7 | ids L160/L161/F010 chosen because other open branches already use L159 and F004-F009 |
