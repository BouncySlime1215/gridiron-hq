...
| L163 | 2026-09-25 | U4 CONSISTENT-CHIP (branch claude/local-u4-consistent-chip) | fantasy | other | 83+ players flagged consistent (rule D) have a better next-4-week floor than 83+ players not flagged, 2024-2025 pooled | next-4 floor (2nd-lowest of 4, missed = 0), flagged - unflagged, 1,047 player-league-weeks | FAILED: 9 flagged player-season clusters (bar 10), CI straddles 0; reader not wired | +0.056 | -3.636 | +4.271 | 95 |  | + | no | `docs/tdd/U4-CONSISTENT-CHIP.md` primary | pooled includes 2025 (2025 alone -0.675 [-4.517, +5.184]); MDE80 5.549 |
