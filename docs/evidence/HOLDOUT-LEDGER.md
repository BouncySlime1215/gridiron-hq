...
| L155 | 2026-09-23 | WV-01 | fantasy | other | Streaming the free-agent DEF with the lowest opponent implied total gains over the held DEF (K = 10), 2025 alone | DEF points per swap-week, 14 swaps | positive (direction check of the pre-registered rule; pooled 2022-2025 rule PASSED, +2.86 [+0.93, +4.75]) | +3.14 | -0.50 | +7.00 | 95 |  | + | yes | `docs/tdd/2026-09-23-wv-01-streaming-board.tdd.md` section 5 | pooled estimate includes 2025 |
| L156 | 2026-09-23 | WV-01 | fantasy | other | Secondary diagnostics including 2025: chase-last-week baseline, implied-vs-chase decision win rate, D/ST points per implied point | per-swap gain / weekly win rate / slope | chase -0.48 [-2.49, +1.61]; win rate 67.4% of 72 weeks; slope +0.45 [+0.38, +0.52] | +0.45 | +0.38 | +0.52 | 95 |  | + | n.a. | `docs/tdd/2026-09-23-wv-01-streaming-board.tdd.md` section 5 | not gating; est/lo/hi are the slope |
| L157 | 2026-09-23 | AI-01 0668d250 | fantasy | FL | Season-to-date xFP per game beats season-to-date PPG for next-5-weeks PPG (2025 reported, not gated; gate 2021-2024 failed) | next-5 PPG MAE, 1,891 player-cutoffs | favours xFP on 2025; unit declined on its 2021-2024 gate | -0.1763 | -0.3068 | -0.0478 | 90 |  | - | no | `docs/tdd/2026-09-23-true-value-opportunity.tdd.md:149` | MDE80 0.196 |
| L158 | 2026-09-23 | AI-01 0668d250 | fantasy | FL | Same, same-position pair accuracy | pair accuracy, 45,846 pairs | not significant | +0.0078 | -0.0061 | +0.0227 | 90 |  | + | no | `docs/tdd/2026-09-23-true-value-opportunity.tdd.md:150` | MDE80 0.0218 |
| L159 | 2026-09-23 | WV-02 (branch claude/local-wv-02-injury-replacement-alert) | fantasy | other | When a starter is Out, the same-team backup with the highest snap share (roleStates) outscores the backup with the highest last-3 PPR ppg | decision win rate on disagreements (29 of 120 events); mean PPR diff over all events | holds on 2025 (primary 2022-2024 failed its non-inferiority bound, so snap order ships default-off) | +1.013 | +0.039 | +1.987 | 90 |  | + | no (default-off) | `docs/tdd/2026-09-23-injury-replacement-alert.tdd.md` section 5 | win rate 0.672, MDE 0.231; local copy, not production |
| L160 | 2026-09-23 | PROJ-00 (branch claude/local-proj-00-history-backfill) | fantasy | other | Data-integrity check, not a hypothesis test: nflverse 2025 pbp and participation load completely, and participation covers PFR offense snaps (no outcome, projection or model graded) | pbp rows vs published count; share of player_week_snaps offense snaps with a participation player-week | PASSED: 48,771 of 48,771 pbp rows; snap match share 0.9885 (pre-set floor 0.95) | 0.9885 |  |  |  |  |  | n.a. | `docs/tdd/2026-09-23-proj-00-history-backfill.tdd.md` section 5 | ESPN leaguedefaults 2025 NOT pulled (licence blocked); local copy, not production |
| L161 | 2026-09-23 | PROJ-00 (branch claude/local-proj-00-history-backfill) | fantasy | other | Data-integrity re-check after the skeptic fixes, not a hypothesis test: 2025 pbp reloads to the published count with two-point tries untyped, and scrimmage-only participation counts the same plays as PFR offense snaps (no outcome, projection or model graded) | pbp rows vs published count; snap match share; participation plays over PFR snaps on matched player-weeks | PASSED: 48,771 of 48,771 pbp rows; snap match share 0.9885 (floor 0.95); matched play ratio 0.9992 | 0.9885 |  |  |  |  |  | n.a. | `docs/tdd/2026-09-23-proj-00-history-backfill.tdd.md` section 10 | fresh scratch DB, local copy of players and snaps, not production |
| L162 | 2026-09-23 | PROJ-00 (branch claude/local-proj-00-history-backfill), PR #218 | fantasy | other | Not a hypothesis test, no grading: ESPN 2025 weekly fantasy projections (public leaguedefaults/3, cookie-free, no espn_s2/swid) pulled for a LOCAL archive only, same method as the 2021-2024 pull (`rnd/loop/r2-external-espn-weekly-projection-history.md` §0, `scripts/r2x_espn_proj_pull.py`) | player count per week (main QB/RB/WR/TE + DST + K files), non-empty check | PULLED: main 800 players, DST 32, K 63; weeks 1-18 all present, 559-775 players/week (2024 comparator: 785-800/week) | | | | | | | n.a. | `rnd/loop/data/espn_proj_hist/espn_leaguedefaults3_2025.json.gz` (+ `_dst`, `_k`) | Nick accepted the Disney ToU risk 2026-09-23 ~6:05 PM ET; corrects the "ESPN leaguedefaults 2025 NOT pulled" note at L160; local copy only, never committed to the public repo |
| L165 | 2026-09-23 | RL-8-2b (branch claude/local-rl-8-2b-trade-split-fresh-test) | fantasy | other | Trade split arm (a): in 1-for-1 Sleeper trades where consensus ROS value and season-to-date PPG disagree, the consensus side gains more rest-of-season starting-lineup points | disagreement win rate on y_L (net_started_pts / n_h_weeks), 97 non-tied trades, chain-clustered | FAILED pre-registered rule (> 0.55 and lower bound > 0.50); 2025 is now used for the trade split question | 0.505 | 0.422 | 0.594 | 90 |  | + | no | `docs/evidence/2026-09-23/trade-split-2025-output.txt:11` | MDE80 0.128; prereg eea0a3bd committed before the run; one look, local copy, not production |
| L166 | 2026-09-23 | RL-8-2b (branch claude/local-rl-8-2b-trade-split-fresh-test) | fantasy | other | Trade split arm (b): PR #200's lineup value with the roster-spot charge names the lineup-points winner in 2-for-1 and 2-for-2 trades where summed consensus fails | win rate on y_L, 263 trades, chain-clustered | FAILED pre-registered rule: LV cleared > 0.55 and lower bound > 0.50, but summed consensus won 0.517 [0.470, 0.569] on the same trades (rule needs <= 0.50) | 0.551 | 0.504 | 0.600 | 90 |  | + | no | `docs/evidence/2026-09-23/trade-split-2025-output.txt:29` | MDE80 0.073; decision win rate LV 0.551 vs summed consensus 0.517; prereg eea0a3bd |
...
| F002 | 2026-09-23 | WV-01 | fantasy | other | DEF streaming gain holds on 2026 weeks played | DEF points per swap-week | not computable: nflverse stats_team_week has 2026 week 1 only, 0 swap-weeks |  |  |  |  |  | + | n.a. | `docs/tdd/2026-09-23-wv-01-streaming-board.tdd.md` section 5 | card labelled not yet checked on 2026 |
| F003 | 2026-09-23 | AI-01 0668d250 | fantasy | other | Rule-5 forward check for AI-01 (xFP ROS vs season-to-date PPG) | eligible 2026 cutoffs (>= 3 games and 5 later weeks) | 0 rows (2026 weeks 1-2 only; control 2025: 1,891 rows); no metric computed |  |  |  |  |  |  | no | `docs/tdd/2026-09-23-true-value-opportunity.tdd.md:151` | local copy, not production |
| F004 | 2026-09-23 | WV-02 | fantasy | other | Same as L159, 2026 weeks already played | decision win rate on disagreements | not measurable: 3 events, 1 disagreement (rule needs 10) | +2.107 | 0 | +4.213 | 90 |  | + | no (default-off) | `docs/tdd/2026-09-23-injury-replacement-alert.tdd.md` section 5 | local copy, not production |
...
| F027 | 2026-09-23 | RL-8-2b (branch claude/local-rl-8-2b-trade-split-fresh-test) | fantasy | other | Trade split (arms a and b) holds on 2026 forward trades | win rate on 2026 trades | not run: no 2026 Sleeper trade outcomes pulled (coordinator ruling NICK-2025: not needed); both arms failed on 2025 anyway |  |  |  |  |  |  | n.a. | `docs/evidence/2026-09-23/trade-split-2025-preregistration.md` section 7 | ids L160/L161/F016 chosen because other open branches already use L159 and F001-F015 (renumbered from F010, which HX-01 also uses) |
...
| F016 | 2026-09-23 | PROJ-02-a | fantasy | other | Chain team plays (pace x gameScriptFor script) beat season-average plays on 2026 week 2 | plays per team-game MAE, chain − season-average, 32 team-weeks | chain ahead (one week) | -3.1250 |  |  |  |  | - | yes (links.plays, rule 5 same-sign check) | `docs/evidence/2026-09-23/proj-02-a-sharp-chain-output.json` `forward.plays` | one week, anecdote; 2023/2024 gate passed first |
| F017 | 2026-09-23 | PROJ-02-a | fantasy | other | Chain pass rate beats season-to-date pass rate on 2026 week 2 | pass-rate MAE, chain − season-to-date, 32 team-weeks | chain ahead (one week) | -0.0303 |  |  |  |  | - | yes (links.pass_rate) | same file, `forward.pass_rate` | one week, anecdote |
| F018 | 2026-09-23 | PROJ-02-a | fantasy | other | Normalized chain targets beat today's targets_per_game on 2026 week 2 | targets MAE per played game, chain − incumbent, 329 player-weeks | chain ahead (one week) | -0.0105 |  |  |  |  | - | no (2023/2024 gate: tie) | same file, `forward.targets` | read only for the same-sign check; not shipped |
| F019 | 2026-09-23 | PROJ-02-a | fantasy | other | Normalized chain carries beat today's carries_per_game on 2026 week 2 | carries MAE per played game, chain − incumbent, 329 player-weeks | chain ahead (one week) | -0.0344 |  |  |  |  | - | no (2023/2024 gate: worse) | same file, `forward.carries` | read only for the same-sign check; not shipped |
