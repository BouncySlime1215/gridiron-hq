...
- Merged: 5:04 AM ET, Sep 24 as `51da23d5`
- Intake: done: (filled by the integration intake agent) pending
- Follow-ups: none needed, or folded into existing units (see the card)
...
- Merged: 10:50 PM ET, Sep 23 as `10d44314`
- Intake: done: (filled by the integration intake agent) pending
- Follow-ups: none needed, or folded into existing units (see the card)
...
- Merged: 8:49 PM ET, Sep 23 as `d861c11c`
- Intake: done: (filled by the integration intake agent) pending
- Follow-ups: none needed, or folded into existing units (see the card)

## #224: fix: stop overcharging positional need in trade pricing (RL-19-1)

- Merged: 8:31 PM ET, Sep 23 as `6cf97a74`
- Intake: done: (filled by the integration intake agent) pending
- Follow-ups: none needed, or folded into existing units (see the card)
...
- Merged: 3:06 PM ET, Sep 23 as `dc4532c6`
- Intake: done: (filled by the integration intake agent) pending
- Follow-ups: none needed, or folded into existing units (see the card)

## #202: Fix: simulations no longer honor a stale-payload's from_week override

- Merged: 2:52 PM ET, Sep 23 as `4e0ddbcd`
- Intake: done: (filled by the integration intake agent) pending
- Follow-ups: none needed, or folded into existing units (see the card)
...
- Merged: 9:08 AM ET, Sep 23 as `c1f17cee`
- Intake: done: (filled by the integration intake agent) pending
- Follow-ups: none needed, or folded into existing units (see the card)

## #185: Flag dead starters on Start/Sit with a ranked replacement

- Merged: 8:57 AM ET, Sep 23 as `9521a62d`
- Intake: done: (filled by the integration intake agent) pending
- Follow-ups: none needed, or folded into existing units (see the card)
...
- Merged: 7:11 AM ET, Sep 23 as `ca64b2cc`
- Intake: done: (filled by the integration intake agent) pending
- Follow-ups: none needed, or folded into existing units (see the card)
...
- Merged: 5:40 AM ET, Sep 23 as `3ac59fea`
- Intake: done: (filled by the integration intake agent) pending
- Follow-ups: none needed, or folded into existing units (see the card)

## #173: Add a check that catches results committed before their pre-registration

- Merged: 5:30 AM ET, Sep 23 as `da77c8cf`
- Intake: done: (filled by the integration intake agent) pending
- Follow-ups: none needed, or folded into existing units (see the card)

## #172: Remove eventOdds, an unused any-sport door into the paid Odds API

- Merged: 5:19 AM ET, Sep 23 as `287e36b1`
- Intake: done: (filled by the integration intake agent) pending
- Follow-ups: none needed, or folded into existing units (see the card)
