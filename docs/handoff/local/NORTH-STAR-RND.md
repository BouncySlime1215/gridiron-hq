...
| C4 | "Go get X" planner | best plan expected title-odds gain vs the finder's best single offer, same world | 3.1-4.8 vs -0.1-2.5 pts (5/5 leagues, proto); r23 IDEA-038 2-for-1 CONFIRMED (5/5 leagues, median +3.1 to +7.5 pp; mostly title transfers from rivals, 110 distinct cores) -> in ACQ-01; IDEA-150 price-at-yes KILLED for its summed-projection belief (count-neutral re-test IDEA-150b queued) | IDEA-038 2-for-1 search, waiver claims inside paths, chained steps, IDEA-150 price at his yes point |
...
| C6 | Timing | title-odds value of acting now vs waiting / selling after spikes | r24: IDEA-151 wait-or-act on Q/D/Out KILLED (2024 CI spans 0; the Out/Doubtful-only cut is about -18 pts but not decisive); IDEA-146 variance-before-checkout KILLED (placebo matches) | IDEA-151 wait-or-act, IDEA-110 sell after primetime, IDEA-146 early checkout warning |
