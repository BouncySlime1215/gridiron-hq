...
0b. **JEV-01 probability crowd + news extraction** (Nick 4:00 PM: "have JEV help with probabilities"; TRADE-INSANE-RND.md "JEV IN THE PROBABILITY LOOP"). A graded source feeding the simulator and clones, plus a reasoning pass that flags contradictions. Check the balance first; cap about $1/day.
