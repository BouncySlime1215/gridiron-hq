...
| NICK-MIG | Standing: every additive migration needs Nick's word (queue rule 12). Pending: 072 (#166 S-03), 073 (#170 FC-SNAP); GR-01 will add rec_ledger (074). Suggest one blanket yes for additive-only migrations (new tables/columns, never drops or deletes). | — | Nick |
