...
2. Ledger rows: no 2025 row was read, so no `L` row. The 2026 week-2 forward looks are `F022`-`F025` (`F001`-`F004` on the branch, F018-F021 at the first merge, renumbered again 2026-09-24 because PROJ-02-a holds F016-F021 on main)
   ...
   that week has no row; F022's note says so.
...
5. Forward check on 2026: F022, holds; weeks 5-17 on the weeks 2-4 rows as a proxy, said so.
