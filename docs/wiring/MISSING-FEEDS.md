...
| `league_roster_snapshots` | fantasy | `server/migrations/058_league_roster_snapshots.js:59`<br>`scripts/collect-roster-snapshots.mjs:113`<br>`scripts/collect-roster-snapshots.mjs:116`<br>`scripts/collect-roster-snapshots.mjs:118` | `bluff-detector.js`<br>`collect-roster-snapshots.mjs` | /api/trades /api/model /api/players |
...
| `league_transactions_raw` | fantasy | `scripts/collect-league-transactions.mjs:34` | `counterparty-pricing.js`<br>`manager-signals.js`<br>`trade-tactics.js`<br>`build-negotiation-profiles.mjs` | /api/league-chat /api/trades /api/model /api/players /api/accolades |
