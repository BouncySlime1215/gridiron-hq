 ...
 *   closed: string|null, consistentOf?, floor?, overpayCap?, depthPremiumMax? } (the last three from the
 *   league's rules block under GRIDIRON_PER_LEAGUE_RULES; absent -> 83, 0 and +12%, Nick's league-4 rules).
