...
import { EspnLeagueMismatchError, espnRequest, leagueUrl } from './espn-client.js';
...
export function fetchDraftDetail(league) {
  return espnRequest(
    leagueUrl(league.league_id, league.season, ['mDraftDetail', 'mSettings', 'mTeam']),
    ...
    if (String(actualLeague) !== String(league.league_id) || Number(actualSeason) !== Number(league.season)) {
